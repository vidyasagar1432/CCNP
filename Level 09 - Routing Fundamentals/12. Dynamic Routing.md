...
**[[Dynamic Routing]]** is the automatic discovery, exchange, and maintenance of routes by **routing protocols**, without manual configuration of each network.
...
- [[08. Static Routing]] — contrasting method
- [[01. Routing Table]] — route population
- [[07. OSPF]] — IGP

## Glossary Terms Used

- [[Dynamic Routing]], [[OSPF]], [[EIGRP]], [[BGP]], [[Static Routing]], [[Metrics]], [[Administrative Distance]]
- [[08. EIGRP]] — IGP

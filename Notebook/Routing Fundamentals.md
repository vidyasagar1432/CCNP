...
Here is a quick map of what this note covers:
...
To tackle this massive topic efficiently, break it down into a logical three-step roadmap:
...
**Routing** is the process of getting a piece of data (called an **IP packet**) from its sender to its destination across different networks.
...
# Part 2: Building the Map vs. Forwarding Packets
...
# Part 3: Router Table Architecture — RIB, FIB, Adjacency Table, and CEF
...
- **The Selection Process:** If multiple sources advertise routes to the exact same network prefix and length, the control plane compares their **Administrative Distance (AD)** to decide which route is the most trustworthy. If there is a tie within a single protocol, it compares the protocol's **Metric**. Only the "winners" (the absolute best routes) are installed into the RIB.
...
# Part 4: CEF Packet Walkthrough — A Real-Life Scenario
...
# Part 5: Administrative Distance (AD)

To truly master routing, we have to look closely at **Administrative Distance (AD)**—the ultimate trust rating system that Cisco routers use to manage competing maps.
...
### The RIB "Waiting Room": How Backups Are Managed
...
# Part 6: Metrics — The Best Path Within a Protocol
...
# Part 8: Autonomous Systems: IGP vs. EGP
...
# Part 9: The Core Routing Algorithms (The Three Families of IGP)
...
## Family A: Distance Vector Protocols — "Routing by Rumor"
...
## Family B: Link-State Protocols — "The Network Road Map"
...
## Family C: Advanced Distance Vector Protocols — "The Hybrid"
...
## Family D: Path Vector — "The Airline Flight Plan"
...
# Part 10: The Core Functions of Dynamic Routing
...
# Part 11: Static Routing Deep Dive
...
## Part 11A: Categorizing Static Routes by Destination
...
## Part 11B: Categorizing Static Routes by Next-Hop
...
## Part 11C: Floating Static Routes (The Network Safety Net)
...
## Part 11D: Static Null Routes (Preventing Loops)
...
## Part 11E: The Static Route Installation Checklist
...
## Part 11F: Verification and Troubleshooting Commands
...
# Part 12: The Default Route — The Gateway of Last Resort
...
# Part 13: Route Summarization (Aggregation)
